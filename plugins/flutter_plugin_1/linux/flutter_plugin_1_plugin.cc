...
G_DEFINE_TYPE(FlutterPlugin_1Plugin, flutter_plugin_1_plugin, g_object_get_type())

// Called when a method call is received from Flutter.
static void flutter_plugin_1_plugin_handle_method_call(
    FlutterPlugin_1Plugin* self,
...
static void flutter_plugin_1_plugin_class_init(FlutterPlugin_1PluginClass* klass) {
...
static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
                           gpointer user_data) {
  FlutterPlugin_1Plugin* plugin = FLUTTER_PLUGIN_1_PLUGIN(user_data);
  flutter_plugin_1_plugin_handle_method_call(plugin, method_call);
}

void flutter_plugin_1_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
