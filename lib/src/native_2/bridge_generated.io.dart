...
class Native2Platform extends FlutterRustBridgeBase<Native2Wire> {
  Native2Platform(ffi.DynamicLibrary dylib) : super(Native2Wire(dylib));
...
class Native2Wire implements FlutterRustBridgeWireBase {
  @internal
  ...
  Native2Wire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Native2Wire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
